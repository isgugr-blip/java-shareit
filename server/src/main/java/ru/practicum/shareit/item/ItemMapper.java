...
public class ItemMapper {
    ...
    public Item createToEntity(User owner, ItemRequest itemRequest, ItemCreateDto payload) {
        if (payload == null) {
            return null;
        }

        return new Item(null, payload.getName(), payload.getDescription(), payload.getAvailable(), owner, itemRequest);
    }
